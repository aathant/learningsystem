      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            @role('Trainer|Admin')
             <a class="collapse-item" href="{{route('trainers.index')}}">Trainer</a>
            @endrole
            @role('Admin')
            <a class="collapse-item" href="{{route('students.index')}}">Student</a>
            @endrole
            @role('Mentor|Admin')
            <a class="collapse-item" href="{{route('mentors.index')}}">Mentor</a>
            @endrole
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('batches.index')}}">Batch</a>
            @endrole
            @role('Trainer|Admin')
            <a class="collapse-item" href="{{route('subjects.index')}}">Subject</a>
            @endrole
          </div>
        </div>
      </li>
