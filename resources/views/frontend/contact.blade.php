...
<div class="container-fluid">
  ...
  <div class="card-body">
    ...
    <p class="card-text">No.169/7B,MTP Condo, Insein Road , Hlaing Township, Yangon. Myanmar.</p>
  </div>
</div>
</div>
...
<div class="col-lg-3 col-md-6 col-sm-12">
  ...
  <div class="card-body">
    ...
    <p class="card-text">+95 9 259288199</p>
  </div>
</div>
</div>
...
<div class="col-lg-3 col-md-6 col-sm-12">
  ...
  <div class="card-body">
    ...
    <p class="card-text">info@myanmaritc.com</p>
  </div>
</div>
</div>
...
<div class="col-lg-3 col-md-6 col-sm-12">
  ...
  <div class="card-body">
    ...
    <p class="card-text">www.myanmaritc.com</p>
  </div>
</div>
</div>
	</div>
...
<div class="form-group">
        <input type="text" name="" class="form-control" id="username" placeholder="Your Name">
      </div>

      <div class="form-group">
        <input type="email" name="" class="form-control" id="useremail" placeholder="Your Email">
      </div>

      <div class="form-group">
        <input type="text" name="" class="form-control" id="userpw" placeholder="subject">
      </div>

       <div class="form-group">
        <input type="textarea" name="" class="form-control" id="userpw">
      </div>

      <div class="mt-4">
        <a href="contact.html" id="contactbtn" class="btn btn-primary">SEND MESSAGE</a>
      </div>
...
<div class="col-lg-6 col-md-12 col-sm-12">
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.6060917364293!2d96.1231666139596!3d16.845886588405236!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1953fc49fb755%3A0x45b19605a43c3143!2sMyanmar%20IT%20Consulting!5e0!3m2!1smy!2smm!4v1580373851322!5m2!1smy!2smm" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
</div>
</div>
</div>
